...
#### Magisk Build:
- Ensure program is using Vulkan for best compatibility - try forcing Vulkan via a [VulkanSwitching](https://www.magiskmodule.com/hypervulkan-switcher/) Magisk Module - *soon to be forked*
